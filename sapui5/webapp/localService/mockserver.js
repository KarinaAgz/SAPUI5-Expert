        ...
        var oMockServerInterface = {
            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise (function(fnResolve,fnReject){
                    var sManifestUrl=sap.ui.require.toUrl(_sAppPath + "mainifest.json"),
                        oManifestModel=new JSONModel(sManifestUrl);

                    oManifestModel.attachRequestCompleted(function(){
                        var oUriParameters=new UriParameters(window.location.href);

                        //parse manifest for loxal metadata URI
                        ...
                        //create a mock server instance or stop the extisting one to reinitialize
                        ...
                        var fnResponse=function(iErrCode, sMessage,aRequest){
                            aRequest.response=function(oXhr){
                                oXhr.repond(iErrCode,{"content-Type" :"text/plain;charset=utf-8"},sMessage);
                            };
                        };
                        ...
                        var sErrorParam=oOptions.errorType || oUriParameters.get("erroType");
